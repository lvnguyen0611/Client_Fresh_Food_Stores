...
export const OREDER_DETAIL_REQUEST = "OREDER_DETAIL_REQUEST";
export const OREDER_DETAIL_SUCCESS = "OREDER_DETAIL_SUCCESS";
export const OREDER_DETAIL_FAIL = "OREDER_DETAIL_FAIL";
